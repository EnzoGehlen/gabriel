<?php
include('../conexao.php');
$sql = "SELECT * FROM imoveis WHERE destaque = 1 ORDER BY id DESC";
            ...
            <div class="container">
                <div class="col-md-12">
                    <div class="navbar-header">
                        ...
                        <a href="../" class="navbar-brand"> <img src="../images/logo-gabriel.png"
                                                                 style="max-height: 50px;"
                                                                 class="logo img-responsive pull-left" alt=""/></a>
                        <!--
...
<div class="uk-margin js-slideshow-animation uk-slideshow"
     uk-slideshow="ratio: false; autoplay: true; autoplayInterval: 3000">
    ...
    <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1">
        ...
        <ul class="uk-slideshow-items" uk-height-viewport="min-height: 300" style="min-height: calc(100vh);">
            ...
            while ($dados = $result->fetch_assoc()) {
                ?>
                <li class="" style="">
                    <img src="../images/imoveis/<?= $dados['imagem1'] ?>" alt="" uk-cover="" class="uk-cover"
                         style="height: 1056px; width: 1584px;">
                    <div class="uk-position-center uk-position-medium uk-text-center">
                        <h1 class="uk-heading-hero" uk-slideshow-parallax="x: 200,-200"
                            style="transform: translate3d(-200px, 0px, 0px);"><?= $dados['titulo'] ?></h1>
                        <a style='border-radius:30px;' class="btn btn-primary btn-lg" href="#imovel-<?= $dados['id'] ?>"
                           uk-toggle>Saiba mais</a>
                        <p class="uk-h1" uk-slideshow-parallax="x: 400,-400"
                           style="transform: translate3d(-400px, 0px, 0px);"></p>
                    </div>
                </li>
            <?php } ?>
        ...
        <div class="uk-position-bottom-center uk-position-medium">
            <ul class="uk-slideshow-nav uk-dotnav uk-flex-center uk-margin">
                ...
                <li uk-slideshow-item="1" class="uk-active"><a href="#"></a></li>
...
<div class="container" uk-filter="target: .js-filter">
    <div class="row">
        ...
        <div class=" uk-flex-center uk-child-width-1-5@s uk-child-width-1-5@m uk-child-width-1-5@xl uk-text-center"
             uk-grid>
            <?php
            while ($dadosCat = $resultCat->fetch_assoc()) {
                ...
                <div>
                    <li uk-filter-control=".categoria-<?= $dadosCat['id'] ?>">
                        <a class="categorias-botao" type="button" onclick="jump(<?= $dadosCat['id'] ?>)">

                            <div class="uk-card uk-card-cinza uk-card-body">


                                <img src="../images/categorias/<?= $dadosCat['img'] ?>" alt=""
                                     class='img img-responsive'
                                     onmouseover="this.src = '../images/categorias/<?= $dadosCat['img_hover'] ?>';"
                                     onmouseout="this.src = '../images/categorias/<?= $dadosCat['img'] ?>';"/>
                                <?= $dadosCat['nome'] ?>
    ...
    <ul class="js-filter uk-child-width-1-2 uk-child-width-1-6@m uk-text-center uk-thumbnav" uk-grid>
        ...
        while ($dadosImv = $resultImoveis->fetch_assoc()) {
            ?>
            <li class="categoria-<?= $dadosImv['categoria_id'] ?>"><a href="#imovel-<?= $dadosImv['id'] ?>"
                                                                      id="cat-<?= $dadosImv['categoria_id'] ?>"
                                                                      class="imovel-<?= $dadosImv['id'] ?>"
                                                                      uk-toggle><img
                            src="../images/imoveis/<?= $dadosImv['imagem1']; ?>" width="200" alt=""></a></li>
            <div id="imovel-<?= $dadosImv['id'] ?>" class="uk-modal-full" uk-modal>
                <div class="uk-modal-dialog">
                    <button class="uk-modal-close-full" style="color: #FFF; background-color: 3cee9"
                            uk-icon="arrow-left" type="button"></button>
                                ...
                                <ul class="uk-thumbnav" uk-margin>
                                    ...
                                    for ($x = 1; $x < 7; $x++) {
                                        if (!empty($dadosImv['imagem' . $x . ''])) {
                                            ?>
                                            <li>
                                                <a href="../images/imoveis/<?= $dadosImv['imagem' . $x] ?>"
                                                   data-caption="Imagem <?= $x ?>">
                                                    <img src="../images/imoveis/<?= $dadosImv['imagem' . $x]; ?>"
                                                         width="200" alt="" onerror="this.style.display='none'"/>
                                                </a>
                                            </li>
        ...
        <div class="row">
            <div class="col-sm-7 footer-copyright">
                ...
                <div class="credits">
                    ...
                    Desenvolvido por <a style="text-decoration: none;" href="mailto:enzo.gehlen@hotmail.com">Enzo
                        Gehlen</a>
                </div>
            </div>
            <a href="https://www.facebook.com/imoveisgc/" class="uk-icon-button  uk-margin-small-right"
               uk-icon="facebook"></a>
            <a href="https://www.instagram.com/gabrielchaves_corretor/?hl=pt-br"
               class="uk-icon-button uk-margin-small-right" uk-icon="instagram"></a>
            <a href="https://api.whatsapp.com/send?phone=5555996237090&text=Ol%C3%A1%20Gabriel,%20estou%20no%20seu%20site.%20Gostaria%20de%20mais%20informa%C3%A7%C3%B5es."
               class="uk-icon-button uk-margin-small-right" uk-icon="whatsapp"></a>
        </div>
    </div>
</footer>
<!---->
