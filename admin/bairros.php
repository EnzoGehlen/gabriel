                                ...
                                <tbody>
                                    ...
                                    while ($dados = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href='../imoveis.php?id=<?= $dados['id'] ?>#content' target="_blank"><i class='fa fa-plus' title="Ver no site"></i></a>
                                                <a href='editBairro.php?id=<?= $dados['id'] ?>'><i class='fa fa-edit' title="Editar"></i></a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Você tem certeza que deseja excluir o bairro <?= $dados['nome'] ?>?</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Cancelar</button>
                                                    <a href='crud.php?func=deletaBairro&id=<?= $dados['id'] ?>'><button type="button"  class="btn btn-outline">Excluir</button></a>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        </div>
